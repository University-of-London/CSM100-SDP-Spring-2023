...
public class BlackjackHand implements Comparable {
  ...
  public static void main(String[] args) {
    ...
    final BlackjackHand hand = new BlackjackHand();

    System.out.println("New hand:");
    System.out.println(hand.toString());

    PlayingCard ace = new PlayingCard(PlayingCard.Rank.ACE, PlayingCard.Suit.SPADES);
  ...
  private int countAces() {
    ...
    for (int i = 0; i < lastFaceUpCard; ++i) {
      if (faceUpCards[i].getRank() == PlayingCard.Rank.ACE) {
        count++;
      }
    }
    return count;
